...
namespace MindTouch.Web {
    ...
    public class DreamCookie {
        ...
        public static DreamCookie ParseSetCookie(XDoc cookie) {
            ...
            return new DreamCookie(cookie["name"].AsText, cookie["value"].AsText, cookie["uri"].AsUri(), expires, version, secure, discard, comment, commentUri, httpOnly);
        }
        ...
        private DreamCookie(string name, string value, XUri uri, DateTime expires, int version, bool secure, bool discard, string comment, XUri commentUri, bool httpOnly) {
            ...
            if(uri != null) {
                ...
                _publicUri = _uri == null ? null : _uri.AsPublicUri();
            }
