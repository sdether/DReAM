...
namespace MindTouch.Dream {
    ...
    public class Plug {
        ...
        internal interface IPlugInterceptor {
            DreamMessage PreProcess(string verb, XUri uri, XUri normalizedUri, DreamMessage message, DreamCookieJar cookies);
            DreamMessage PostProcess(string verb, XUri uri, XUri normalizedUri, DreamMessage message, DreamCookieJar cookies);
        }
        ...
        public static Plug New(string uri, TimeSpan timeout) {
            if(uri != null) {
                return new Plug(new XUri(uri), timeout, null, null, null, null, null);
            }
            return null;
        }
        ...
        public static Plug New(XUri uri, TimeSpan timeout) {
            if(uri != null) {
                return new Plug(uri, timeout, null, null, null, null, null);
            }
            return null;
        }
        ...
        public Plug(XUri uri, TimeSpan timeout, DreamHeaders headers, List<PlugHandler> preHandlers, List<PlugHandler> postHandlers, ICredentials credentials, DreamCookieJar cookieJarOverride) {
            if(uri == null) {
        ...
        public Plug At(params string[] segments) {
            ...
            return new Plug(Uri.At(segments), Timeout, _headers, _preHandlers, _postHandlers, Credentials, _cookieJarOverride);
        }
        ...
        public Plug AtPath(string path) {
            return new Plug(Uri.AtPath(path), Timeout, _headers, _preHandlers, _postHandlers, Credentials, _cookieJarOverride);
        }
        ...
        public Plug With(string key, bool value) {
            return new Plug(Uri.With(key, value.ToString()), Timeout, _headers, _preHandlers, _postHandlers, Credentials, _cookieJarOverride);
        }
        ...
        public Plug With(string key, DateTime value) {
            return new Plug(Uri.With(key, value.ToUniversalTime().ToString("R")), Timeout, _headers, _preHandlers, _postHandlers, Credentials, _cookieJarOverride);
        }
        ...
        public Plug WithParams(KeyValuePair<string, string>[] args) {
            return new Plug(Uri.WithParams(args), Timeout, _headers, _preHandlers, _postHandlers, Credentials, _cookieJarOverride);
        }
        ...
        public Plug WithQuery(string query) {
            return new Plug(Uri.WithQuery(query), Timeout, _headers, _preHandlers, _postHandlers, Credentials, _cookieJarOverride);
        }
        ...
        public Plug WithParamsFrom(XUri uri) {
            return new Plug(Uri.WithParamsFrom(uri), Timeout, _headers, _preHandlers, _postHandlers, Credentials, _cookieJarOverride);
        }
        ...
        public Plug WithCredentials(string user, string password) {
            return new Plug(Uri.WithCredentials(user, password), Timeout, _headers, _preHandlers, _postHandlers, Credentials, _cookieJarOverride);
        }
        ...
        public Plug WithCredentials(ICredentials credentials) {
            return new Plug(Uri, Timeout, _headers, _preHandlers, _postHandlers, credentials, _cookieJarOverride);
        }
        ...
        public Plug WithoutCredentials() {
            return new Plug(Uri.WithoutCredentials(), Timeout, _headers, _preHandlers, _postHandlers, null, _cookieJarOverride);
        }
        ...
        public Plug WithCookieJar(DreamCookieJar cookieJar) {
            return new Plug(Uri, Timeout, _headers, _preHandlers, _postHandlers, Credentials, cookieJar);
        }
        ...
        public Plug WithoutCookieJar() {
            return new Plug(Uri, Timeout, _headers, _preHandlers, _postHandlers, Credentials, null);
        }
        ...
        public Plug WithHeader(string name, string value) {
            ...
            return new Plug(Uri, Timeout, newHeaders, _preHandlers, _postHandlers, Credentials, _cookieJarOverride);
        }
        ...
        public Plug WithoutHeaders() {
            return new Plug(Uri, Timeout, null, _preHandlers, _postHandlers, Credentials, _cookieJarOverride);
        }
        ...
        public Plug WithPreHandler(params PlugHandler[] preHandlers) {
            ...
            return new Plug(Uri, Timeout, _headers, list, _postHandlers, Credentials, _cookieJarOverride);
        }
        ...
        public Plug WithPostHandler(params PlugHandler[] postHandlers) {
            ...
            return new Plug(Uri, Timeout, _headers, _preHandlers, list, Credentials, _cookieJarOverride);
        }
        ...
        public Plug WithoutHandlers() {
            return new Plug(Uri, Timeout, _headers, null, null, Credentials, _cookieJarOverride);
        }
        ...
        public DreamMessage PostAsForm() {
            ...
            return WaitAndConfirm(new Plug(uri, Timeout, _headers, _preHandlers, _postHandlers, Credentials, _cookieJarOverride).Invoke(Verb.POST, message, new Result<DreamMessage>(TimeSpan.MaxValue)));
        }
        ...
        public Result<DreamMessage> PostAsForm(Result<DreamMessage> result) {
            DreamMessage message = DreamMessage.Ok(Uri.Params);
            XUri uri = Uri.WithoutParams();
            return new Plug(uri, Timeout, Headers, _preHandlers, _postHandlers, Credentials, _cookieJarOverride).Invoke(Verb.POST, message, result);
        }
        ...
        public Result<DreamMessage> InvokeEx(string verb, DreamMessage request, Result<DreamMessage> result) {
            ...
            try {
                ...
                if(_preHandlers != null) {
                    foreach(PlugHandler handler in _preHandlers) {
            ...
            var inner = new Result<DreamMessage>(timeout, TaskEnv.None).WhenDone(
                message => {
                    try {
                        ...
                        if(_postHandlers != null) {
                            foreach(PlugHandler handler in _postHandlers) {
...
#pragma warning restore 618
        ...
        public Result<DreamMessage> PostAsFormAsync() {
            DreamMessage message = DreamMessage.Ok(Uri.Params);
            XUri uri = Uri.WithoutParams();
            return new Plug(uri, Timeout, Headers, _preHandlers, _postHandlers, Credentials, _cookieJarOverride).Invoke(Verb.POST, message, new Result<DreamMessage>(TimeSpan.MaxValue));
        }
