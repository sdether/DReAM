...
namespace MindTouch.Dream.Test {
    ...
    public class DreamHostTest {
        ...
        public void ServiceTest() {
            ...
            _host.At("blueprints").Post(new XDoc("blueprint").Elem("assembly", "test.mindtouch.web.server").Elem("class", "MindTouch.Dream.Test.SampleService"));
            _host.At("blueprints").Post(new XDoc("blueprint").Elem("assembly", "test.mindtouch.web.server").Elem("class", "MindTouch.Dream.Test.SampleInnerService"));
        ...
        public void BadServiceTest() {
            ...
            _host.At("blueprints").Post(new XDoc("blueprint").Elem("assembly", "test.mindtouch.web.server").Elem("class", "MindTouch.Dream.Test.SampleBadService"));
