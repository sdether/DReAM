...
namespace MindTouch.Dream.Test.Mock {
    ...
    public class PlugCalled {
        ...
        public enum Result {
            ...
            /// <summary>
            /// <see cref="PlugCalled.Verify(int)"/> was called with too few occurences.
            /// </summary>
            TooFew,
            /// <summary>
            /// <see cref="PlugCalled.Verify(int)"/> was called with too many occurences.
            /// </summary>
            TooMany,
            /// <summary>
            /// <see cref="PlugCalled.Verify(int)"/> was called with the expected number of occurences.
            /// </summary>
            Ok
        }
        ...
        public static PlugCalled AtLeast(int count) {
            return new PlugCalled(count, Type.AtLeast);
        }
        ...
        /// </summary>
        /// <returns>New instance.</returns>
        public static PlugCalled AtLeastOnce() {
            return new PlugCalled(1, Type.AtLeast);
        }
        ...
        /// <param name="count">Occurence count.</param>
        /// <returns>New instance.</returns>
        public static PlugCalled AtMost(int count) {
            return new PlugCalled(count, Type.AtMost);
        }
        ...
        /// </summary>
        /// <returns>New instance.</returns>
        public static PlugCalled AtMostOnce() {
            return new PlugCalled(1, Type.AtMost);
        }
        ...
        /// </summary>
        /// <returns>New instance.</returns>
        public static PlugCalled Never() {
            return new PlugCalled(0, Type.Exactly);
        }
        ...
        /// </summary>
        /// <returns>New instance.</returns>
        public static PlugCalled Once() {
            return new PlugCalled(1, Type.Exactly);
        }
        ...
        /// <param name="count">Occurence count.</param>
        /// <returns>New instance.</returns>
        public static PlugCalled Exactly(int count) {
            return new PlugCalled(count, Type.Exactly);
        }
        ...
        //--- Constructors ---
        private PlugCalled(int times, Type type) {
            _times = times;
            _type = type;
        }
