...
namespace MindTouch.Dream.Test.Mock {
    ...
    public interface IMockPlug {
        ...
        /// <summary>
        /// Expect user and password credentials in Uri.
        /// </summary>
        /// <param name="user">user.</param>
        /// <param name="password">password.</param>
        /// <returns></returns>
        IMockPlug WithCredentials(string user, string password);
        ...
        /// <summary>
        /// Verify that the <see cref="MockPlug"/> was called the expected number of <see cref="PlugCalled"/>
        /// </summary>
        /// <remarks>Uses a 5 second timeout.</remarks>
        /// <param name="called">Times instance to use for expectations.</param>
        void Verify(PlugCalled called);
        ...
        /// <param name="timeout">The time to wait for expectations to be met.</param>
        /// <param name="called">Times instance to use for expectations.</param>
        void Verify(TimeSpan timeout, PlugCalled called);
        ...
        /// <summary>
        /// Set expectations to be the specified <see cref="PlugCalled"/>.
        /// </summary>
        /// <param name="called"></param>
        /// <returns></returns>
        IMockPlug ExpectCalls(PlugCalled called);
    }
}