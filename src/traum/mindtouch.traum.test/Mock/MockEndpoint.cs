...
namespace MindTouch.Traum.Test.Mock {
    internal class MockEndpoint : IPlugEndpoint2 {
        ...
        private static readonly MockPlug2.IMockInvokee DefaultInvokee = new MockPlug2.MockInvokee(null, (p, v, u, r) => TaskUtil.Result(DreamMessage2.Ok(new XDoc("empty"))), int.MaxValue);
