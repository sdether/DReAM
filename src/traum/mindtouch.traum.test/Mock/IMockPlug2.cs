...
namespace MindTouch.Traum.Test.Mock {

    /// <summary>
    /// Interface describing a <see cref="MockPlug2"/> definition.
    /// </summary>
    public interface IMockPlug2 {
        ...
        /// <returns>Same instance of <see cref="IMockPlug2"/>.</returns>
        IMockPlug2 At(params string[] path);
        ...
        /// <returns>Same instance of <see cref="IMockPlug2"/>.</returns>
        IMockPlug2 With(string key, string value);
        ...
        /// <returns>Same instance of <see cref="IMockPlug2"/>.</returns>
        IMockPlug2 With(string key, Predicate<string> valueCallback);
        ...
        /// <remarks>By default presence or lack of presence of trailing slashes is not considered when matching, but this call makes it significant</remarks>
        /// <returns>Same instance of <see cref="IMockPlug2"/>.</returns>
        IMockPlug2 WithoutTrailingSlash();
        ...
        IMockPlug2 WithBody(XDoc request);
        ...
        /// <returns>Same instance of <see cref="IMockPlug2"/>.</returns>
        IMockPlug2 WithHeader(string key, string value);
        ...
        /// <returns>Same instance of <see cref="IMockPlug2"/>.</returns>
        IMockPlug2 WithHeader(string key, Predicate<string> valueCallback);
        ...
        /// <param name="response">Response message.</param>
        /// <returns>Same instance of <see cref="IMockPlug2"/>.</returns>
        IMockPlug2 Returns(XDoc response);
        ...
        /// <param name="value">Header value.</param>
        /// <returns>Same instance of <see cref="IMockPlug2"/>.</returns>
        IMockPlug2 WithResponseHeader(string key, string value);

        /// <summary>
        /// Verify that the <see cref="MockPlug2"/> was called as expected.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Verify that the <see cref="MockPlug2"/> was called the expected number of <see cref="Times"/>
        /// </summary>
        ...
        /// </summary>
        /// <returns></returns>
        IMockPlug2 ExpectAtLeastOneCall();
        ...
        /// <returns></returns>
        IMockPlug2 ExpectCalls(Times called);
    }
}