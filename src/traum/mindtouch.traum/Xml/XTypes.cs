...
using MindTouch.Web;
using DreamResponseException = MindTouch.Traum.DreamResponseException;
...
namespace MindTouch.Xml {
    ...
    public class XException2 : XDoc {
        ...
        public XException2(Exception e) : base("exception") {
            ...
            if(e.InnerException != null) {
                Add(new XException2(e.InnerException));
            }

            // check if a response is present
            if(e is DreamResponseException) {
                Add(new XMessage2(((DreamResponseException)e).Response));
            }
        }
    }

    /// <summary>
    /// Provides a mechanism for serializing a <see cref="DreamMessage2"/> as an Xml document.
    /// </summary>
    public class XMessage2 : XDoc {
        ...
        public XMessage2(DreamMessage2 message)
            : base("message") {
