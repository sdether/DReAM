...
using MindTouch.Dream.Web.Server;
using MindTouch.Dream.Web.Server.Plug;
...
namespace MindTouch.Dream {
    ...
    public class DreamContext : ITaskLifespan {
        ...
        //--- Class Constructor ---
        static DreamContext() {
            Plug.SetCookieJarSource(new DreamContextCookieJarSource());
            Plug.SetInterceptor(new DreamContextPlugInterceptor());
            DreamMessage.SetDiagnosticsInterceptor(new DreamMessageDiagnosticsInterceptor());
            XUriEx.UriTranslator = new DreamContextUriTranslator();
        }
